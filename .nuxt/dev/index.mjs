globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unified/index.js';
import { toString } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/detab/index.js';
import { u } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/mdurl/index.js';
import slugify from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/slugify/slugify.js';
import { position } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unist-util-position/index.js';
import { visit } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/unenv/runtime/npm/consola.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/ccj/Documents/repos/cryptochrisjames.github.io/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/ccj/Documents/repos/cryptochrisjames.github.io/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/ccj/Documents/repos/cryptochrisjames.github.io/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ccj/Documents/repos/cryptochrisjames.github.io","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ccj/Documents/repos/cryptochrisjames.github.io/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ccj/Documents/repos/cryptochrisjames.github.io/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ccj/Documents/repos/cryptochrisjames.github.io/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/ccj/Documents/repos/cryptochrisjames.github.io/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _k2Tz8F = defineEventHandler(async (event) => {
...
const _P3bRXo = defineEventHandler(async (event) => {
...
const _doOZBT = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_02g5iv = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_02g5iv, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _k2Tz8F, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _k2Tz8F, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _k2Tz8F, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _P3bRXo, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _doOZBT, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _doOZBT, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _doOZBT, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_02g5iv, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/ccj/Documents/repos/cryptochrisjames.github.io/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/ccj/Documents/repos/cryptochrisjames.github.io/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
